 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_SetDMAAddress(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_GetDMAAddress(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_SetBlockSize(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_SetBlockCount(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint16_t result = SDHC_PDD_GetBlockCount(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_SetCommandArgument(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_SendCommand(deviceID, SDHC_PDD_CMD0_GO_IDLE_STATE,
 *      SDHC_PDD_ENABLE_DMA);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_GetCommandResponse(deviceID, [Response]);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_SetBufferData(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_GetBufferData(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_IsCommandInhibited(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_IsDataCommandInhibited(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_IsDataLineActive(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_IsSDClockStable(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_IsControllerClockGatedOff(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_IsCrossbarClockGatedOff(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_IsPeripheralClockGatedOff(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_IsSDHCClockGatedOff(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_IsWriteTransferActive(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_IsReadTransferActive(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_IsBufferWriteEnabled(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_IsBufferReadEnabled(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_IsCardInserted(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_GetCMDLineLevel(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_GetDATLineLevel(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_SetLEDState(deviceID, SDHC_PDD_LED_ON);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_SetDataTransferWidth(deviceID, SDHC_PDD_1_BIT_MODE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_EnableDAT3AsCardDetectionPin(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_SetEndianMode(deviceID, SDHC_PDD_BIG_ENDIAN_MODE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_GetCardDetectTestLevel(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_EnableCardDetectionTestLevel(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_SetDMAMode(deviceID, SDHC_PDD_NO_OR_SIMPLE_DMA_MODE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_EnableStopAtBlockGapRequest(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_ContinueRequest(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_EnableReadWaitControl(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_EnableInterruptAtBlockGap(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_EnableWakeUpOnCardInterrupt(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_EnableWakeUpOnCardInsertion(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_EnableWakeUpOnCardRemoval(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_EnableControllerClock(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_EnableCrossbarClock(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_EnablePeripheralClock(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_EnableSDHCClock(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_SetSDHCClockDivisor(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_SetSDHCClockFrequency(deviceID, SDHC_PDD_BASE_DIV_BY_2);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_SetDataTimeout(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_ResetCMDLine(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_ResetDATLine(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_IsCardInitComplete(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_GetInterruptFlags(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_ClearInterruptFlags(deviceID, SDHC_PDD_COMMAND_COMPLETE_INT);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_EnableInterrupts(deviceID, SDHC_PDD_COMMAND_COMPLETE_INT);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_DisableInterrupts(deviceID, SDHC_PDD_COMMAND_COMPLETE_INT);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_EnableInterruptFlags(deviceID, SDHC_PDD_COMMAND_COMPLETE_INT);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_DisableInterruptFlags(deviceID, SDHC_PDD_COMMAND_COMPLETE_INT);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_GetAutoCMD12ErrorFlags(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_GetHostCapabilities(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_GetMaxBlockLength(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_SetWriteWatermark(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_SetReadWatermark(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_ForceEvents(deviceID, SDHC_PDD_AUTO_CMD12_NOT_EXECUTED_EVENT);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_GetADMALengthMismatchErrorFlag(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_GetADMADescriptorErrorFlag(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_GetADMAErrorState(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_SetADMAAddress(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_GetADMAAddress(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_EnableExternalDMARequest(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_EnableExactBlockNum(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_SetBootAckTimeout(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_EnableBootAck(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_SetBootMode(deviceID, SDHC_PDD_NORMAL_BOOT);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_EnableBootMode(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_EnableAutoStopAtBlockGap(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_SetBootBlockCount(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_GetSpecificationVersion(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = SDHC_PDD_GetVendorVersion(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      SDHC_PDD_SetClockSource(deviceID, SDHC_PDD_CORE_SYSTEM_CLOCK);
 *      @endcode
 */
