...
#define TSS_USE_MQX                            1      /* MQX operating system is used */
...
#define TSS_TSI_RESOLUTION               4            /* Required Bit resolution of the TSI */

/* Active Mode Clock Settings */
#define TSS_TSI_AMCLKS              0                 /* Input Active Mode Clock Source ( 0 = BUSclk, 1 = MCGIRCLK, 2 = OSCERCLK, 3 - NA ) */
#define TSS_TSI_AMPSC               0                 /* Input Active Mode Clock Prescaler ( 0 = divide 1, 7 = divide 128 ) */
#define TSS_TSI_AMCLKDIV            1                 /* Input Active Mode Clock Divider ( 0 = divide 1, 1 = divide 2048 ) */
/* Low Power TSI definition */
#define TSS_TSI_LPCLKS              0                 /* Low Power Mode Clock Source ( 0 = LPOCLK, 1 = VLPOSCCLK ) */
/* Scan Settings */
