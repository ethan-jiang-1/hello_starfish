...
**     Date/Time   : 2013-04-26, 14:50, # CodeGen: 16
**     Abstract    :
...
** @file I2C.c
** @version 01.06
** @date 2013-04-26, 14:50, # CodeGen: 16
** @brief
**          This component encapsulates the internal I2C communication
**          interface. The implementation of the interface is based
**          on the Philips I2C-bus specification version 2.0.
...
void I2C_Interrupt(LDD_RTOS_TISRParameter _isrParameter)
{
  ...
  if (ErrorMask != 0x00U) {            /* Is any error mask set? */
    ...
    I2C_OnError(DeviceDataPrv->UserData); /* If yes then invoke user event */
  }
}
...
LDD_TDeviceData* I2C_Init(LDD_TUserData *UserDataPtr)
{
  ...
  DeviceDataPrv->SavedISRSettings.isrFunction = _int_install_isr(LDD_ivIndex_INT_I2C0, I2C_Interrupt, DeviceDataPrv);
  ...
  I2C0_F = (I2C_F_MULT(0x00) | I2C_F_ICR(0x25)); /* Set prescaler bits */
...
void I2C_Deinit(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  (void)_int_install_isr(LDD_ivIndex_INT_I2C0, ((I2C_TDeviceDataPtr)DeviceDataPtr)->SavedISRSettings.isrFunction, ((I2C_TDeviceDataPtr)DeviceDataPtr)->SavedISRSettings.isrData);
  /* Unregistration of the device structure */
  PE_LDD_UnregisterDeviceStructure(PE_LDD_COMPONENT_I2C_ID);
