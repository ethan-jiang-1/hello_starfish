...
**     Version     : Component 02.001, Driver 01.00, CPU db: 3.00.000
**     Compiler    : Keil ARM C/C++ Compiler
**     Date/Time   : 2013-04-18, 10:22, # CodeGen: 13
**     Contents    :
**         Configure - byte TSS1_Configure(void);
**
**     (c) Copyright Freescale Semiconductor, Inc. 2010
...
{
  /* RTOS interrupt vectors installation */

  /* {MQXLite RTOS Adapter} Set new interrupt vector (function handler and ISR parameter) */
  (void)_int_install_isr(LDD_ivIndex_INT_TSI0, TSS_TSI0Isr, NULL);
