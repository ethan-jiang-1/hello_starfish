...
static const uint8_t ChannelDevice[PWMTimerRGB_NUMBER_OF_CHANNELS] = {0x02U,0x04U,0x05U};

/* Table of channels mode / 0 - compare mode, 1 - capture mode */
static const uint8_t ChannelMode[PWMTimerRGB_NUMBER_OF_CHANNELS] = {0x00U,0x00U,0x00U};


typedef struct {
  uint32_t Source;                     /* Current source clock */
  LDD_TUserData *UserDataPtr;          /* RTOS device data structure */
} PWMTimerRGB_TDeviceData;

typedef PWMTimerRGB_TDeviceData *PWMTimerRGB_TDeviceDataPtr; /* Pointer to the device data structure. */

/* {MQXLite RTOS Adapter} Static object used for simulation of dynamic driver memory allocation */
static PWMTimerRGB_TDeviceData DeviceDataPrv__DEFAULT_RTOS_ALLOC;

#define AVAILABLE_PIN_MASK (LDD_TPinMask)(PWMTimerRGB_CHANNEL_0_PIN | PWMTimerRGB_CHANNEL_1_PIN | PWMTimerRGB_CHANNEL_2_PIN)
...
LDD_TDeviceData* PWMTimerRGB_Init(LDD_TUserData *UserDataPtr)
{
  ...
  PWMTimerRGB_TDeviceData *DeviceDataPrv;
  ...
  PE_LDD_RegisterDeviceStructure(PE_LDD_COMPONENT_PWMTimerRGB_ID,DeviceDataPrv);
...
{
  PWMTimerRGB_TDeviceData *DeviceDataPrv = (PWMTimerRGB_TDeviceData *)DeviceDataPtr;

  (void)DeviceDataPrv;
  TPM_PDD_SelectPrescalerSource(TPM0_BASE_PTR, TPM_PDD_DISABLED);
  /* Unregistration of the device structure */
  PE_LDD_UnregisterDeviceStructure(PE_LDD_COMPONENT_PWMTimerRGB_ID);
...
{
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
  return (PWMTimerRGB_TValueType)TPM_PDD_ReadCounterReg(TPM0_BASE_PTR);
}
...
LDD_TError PWMTimerRGB_GetOffsetTicks(LDD_TDeviceData *DeviceDataPtr, uint8_t ChannelIdx, PWMTimerRGB_TValueType *TicksPtr)
{
  ...
  *TicksPtr = (PWMTimerRGB_TValueType)(TPM_PDD_ReadChannelValueReg(TPM0_BASE_PTR, ChannelDevice[ChannelIdx]));
  return ERR_OK;                       /* OK */
}
