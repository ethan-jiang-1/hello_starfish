...
#define IMAGE4_START_ADD     (WAVFORM_START_ADDR+WAVEFORM_LENGTH)
#define IMAGE4_LENGTH        (90000)

#define IMAGE5_START_ADD     (IMAGE4_START_ADD+IMAGE4_LENGTH)
#define IMAGE5_LENGTH        (108000)

#define IMAGE6_START_ADD     (IMAGE5_START_ADD+IMAGE5_LENGTH)
#define IMAGE6_LENGTH        (108000)

#define IMAGE7_START_ADD     (IMAGE6_START_ADD+IMAGE6_LENGTH)
#define IMAGE7_LENGTH        (108000)

#define IMAGE8_START_ADD     (IMAGE7_START_ADD+IMAGE7_LENGTH)
#define IMAGE8_LENGTH        (108000) 

#define IMAGE9_START_ADD     (IMAGE8_START_ADD+IMAGE8_LENGTH)
#define IMAGE9_LENGTH        (32400)


#define CUP_IMAGE_START_ADD      (IMAGE9_START_ADD+IMAGE9_LENGTH)//0x11ed4
#define IMAGESIZE (360*600/2)  //108000 byte
#define FIRSTFILESECTOR ((CUP_IMAGE_START_ADD/4096)+1)
