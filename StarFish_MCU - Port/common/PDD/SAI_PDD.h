 ...
 *          I2S_TCSR (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 * @return Returns a value of void type.
 * @remarks The macro accesses the following registers: I2S0_TCR2, I2S1_TCR2,
 *          I2S_TCR2 (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 * @return Returns a value of void type.
 * @remarks The macro accesses the following registers: I2S0_TCR3, I2S1_TCR3,
 *          I2S_TCR3 (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *          I2S_TCR4 (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *          I2S_TCR5 (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *          I2S_TMR (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *          I2S_RCSR (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 * @return Returns a value of void type.
 * @remarks The macro accesses the following registers: I2S0_RCR2, I2S1_RCR2,
 *          I2S_RCR2 (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 * @return Returns a value of void type.
 * @remarks The macro accesses the following registers: I2S0_RCR3, I2S1_RCR3,
 *          I2S_RCR3 (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *          I2S_RCR4 (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *          I2S_RCR5 (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *          I2S_RMR (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *          I2S_MCR (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *          I2S_MDR (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *        (PDD_DISABLE and PDD_ENABLE defined in PDD_Types.h)" type.
 * @return Returns a value of void type.
 * @remarks The macro accesses the following registers: I2S0_TCR3, I2S_TCR3
 *          (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 *        (PDD_DISABLE and PDD_ENABLE defined in PDD_Types.h)" type.
 * @return Returns a value of void type.
 * @remarks The macro accesses the following registers: I2S0_RCR3, I2S_RCR3
 *          (depending on the peripheral).
 * @par Example:
 *      @code
 ...
 * @return Returns a value of void type.
 * @remarks The macro accesses the following registers: I2S_TCR2.
 * @par Example:
 *      @code
 ...
 *        macro).". This parameter is 2 bits wide.
 * @return Returns a value of void type.
 * @remarks The macro accesses the following registers: I2S_RCR2.
 * @par Example:
 *      @code
