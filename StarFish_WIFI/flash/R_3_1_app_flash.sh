...
#cp -f $CURR_DIR/$FINAL_FLASH_FILENAME $BIN_DIR/$FINAL_FLASH_FILENAME
rm -f sub_fill1.bin
rm -f sub_fill2.bin
...
#cp -f $CURR_DIR/$OUT_FILENAME $BIN_DIR/$OUT_FILENAME
...
cp raw_flashimage_AR400X_REV2_IOT.bin ../output/raw_sdkapp.bin
cp ota.bin ../output/ota_sdkapp.bin
